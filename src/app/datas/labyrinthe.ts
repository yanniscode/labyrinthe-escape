...
export class Labyrinthe {
    ...
    private construireLabyrinthe(dimX: number, dimY: number): Bloc[][] {
        ...
        this.blocs[0][11] = new Bloc(new Point(0, 11), TypeBloc.MUR);
        ...
        this.blocs[1][10] = new Bloc(new Point(1, 10), TypeBloc.VIDE);
        this.blocs[1][11] = new Bloc(new Point(1, 11), TypeBloc.MUR);

        this.blocs[2][0] = new Bloc(new Point(2, 0), TypeBloc.MUR);
        this.blocs[2][1] = new Bloc(new Point(2, 1), TypeBloc.VIDE);
        this.blocs[2][2] = new Bloc(new Point(2, 2), TypeBloc.VIDE);
        this.blocs[2][3] = new Bloc(new Point(2, 3), TypeBloc.VIDE);
        ...
        this.blocs[2][10] = new Bloc(new Point(2, 10), TypeBloc.VIDE);
        this.blocs[2][11] = new Bloc(new Point(2, 11), TypeBloc.MUR);
        
        this.blocs[3][0] = new Bloc(new Point(3, 0), TypeBloc.MUR);
        this.blocs[3][1] = new Bloc(new Point(3, 1), TypeBloc.VIDE);
        this.blocs[3][2] = new Bloc(new Point(3, 2), TypeBloc.MUR);
        this.blocs[3][3] = new Bloc(new Point(3, 3), TypeBloc.VIDE);
        this.blocs[3][4] = new Bloc(new Point(3, 4), TypeBloc.MUR);
        ...
        this.blocs[3][8] = new Bloc(new Point(3, 8), TypeBloc.VIDE);
        this.blocs[3][9] = new Bloc(new Point(3, 9), TypeBloc.MUR);
        this.blocs[3][10] = new Bloc(new Point(3, 10), TypeBloc.VIDE);
        this.blocs[3][11] = new Bloc(new Point(3, 11), TypeBloc.MUR);
        ...
        this.blocs[4][3] = new Bloc(new Point(4, 3), TypeBloc.VIDE);
        this.blocs[4][4] = new Bloc(new Point(4, 4), TypeBloc.MUR);
        this.blocs[4][5] = new Bloc(new Point(4, 5), TypeBloc.VIDE);
        this.blocs[4][6] = new Bloc(new Point(4, 6), TypeBloc.MUR);
        this.blocs[4][7] = new Bloc(new Point(4, 7), TypeBloc.VIDE);
        this.blocs[4][8] = new Bloc(new Point(4, 8), TypeBloc.VIDE);
        this.blocs[4][9] = new Bloc(new Point(4, 9), TypeBloc.MUR);
        this.blocs[4][10] = new Bloc(new Point(4, 10), TypeBloc.VIDE);
        this.blocs[4][11] = new Bloc(new Point(5, 11), TypeBloc.MUR);
        ...
        this.blocs[5][4] = new Bloc(new Point(5, 4), TypeBloc.MUR);
        this.blocs[5][5] = new Bloc(new Point(5, 5), TypeBloc.VIDE);
        this.blocs[5][6] = new Bloc(new Point(5, 6), TypeBloc.MUR);
        this.blocs[5][7] = new Bloc(new Point(5, 7), TypeBloc.VIDE);
        this.blocs[5][8] = new Bloc(new Point(5, 8), TypeBloc.VIDE);
        this.blocs[5][9] = new Bloc(new Point(5, 9), TypeBloc.MUR);
        this.blocs[5][10] = new Bloc(new Point(5, 10), TypeBloc.VIDE);
        this.blocs[5][11] = new Bloc(new Point(5, 11), TypeBloc.MUR);
        ...
        this.blocs[6][5] = new Bloc(new Point(6, 5), TypeBloc.VIDE);
        this.blocs[6][6] = new Bloc(new Point(6, 6), TypeBloc.MUR);
        this.blocs[6][7] = new Bloc(new Point(6, 7), TypeBloc.MUR);
        this.blocs[6][8] = new Bloc(new Point(6, 8), TypeBloc.MUR);
        this.blocs[6][9] = new Bloc(new Point(6, 9), TypeBloc.MUR);
        this.blocs[6][10] = new Bloc(new Point(6, 10), TypeBloc.VIDE);
        this.blocs[6][11] = new Bloc(new Point(6, 11), TypeBloc.MUR);
        ...
        this.blocs[7][4] = new Bloc(new Point(7, 4), TypeBloc.MUR);
        this.blocs[7][5] = new Bloc(new Point(7, 5), TypeBloc.VIDE);
        this.blocs[7][6] = new Bloc(new Point(7, 6), TypeBloc.VIDE);
        this.blocs[7][7] = new Bloc(new Point(7, 7), TypeBloc.VIDE);
        this.blocs[7][8] = new Bloc(new Point(7, 8), TypeBloc.VIDE);
        this.blocs[7][9] = new Bloc(new Point(7, 9), TypeBloc.VIDE);
        this.blocs[7][10] = new Bloc(new Point(7, 10), TypeBloc.VIDE);
        this.blocs[7][11] = new Bloc(new Point(7, 11), TypeBloc.MUR);
        ...
        this.blocs[8][3] = new Bloc(new Point(8, 3), TypeBloc.MUR);
        this.blocs[8][4] = new Bloc(new Point(8, 4), TypeBloc.MUR);
        this.blocs[8][5] = new Bloc(new Point(8, 5), TypeBloc.MUR);
        this.blocs[8][6] = new Bloc(new Point(8, 6), TypeBloc.MUR);
        this.blocs[8][7] = new Bloc(new Point(8, 7), TypeBloc.MUR);
        ...
        this.blocs[8][11] = new Bloc(new Point(8, 11), TypeBloc.MUR);
        ...
        this.blocs[9][7] = new Bloc(new Point(9, 7), TypeBloc.MUR);
        ...
        this.blocs[9][11] = new Bloc(new Point(9, 11), TypeBloc.MUR);

        this.blocs[10][0] = new Bloc(new Point(10, 0), TypeBloc.MUR);
        this.blocs[10][1] = new Bloc(new Point(10, 1), TypeBloc.SORTIE);
        this.blocs[10][2] = new Bloc(new Point(10, 2), TypeBloc.MUR);
        this.blocs[10][3] = new Bloc(new Point(10, 3), TypeBloc.MUR);
        this.blocs[10][4] = new Bloc(new Point(10, 4), TypeBloc.MUR);
        this.blocs[10][5] = new Bloc(new Point(10, 5), TypeBloc.MUR);
        this.blocs[10][6] = new Bloc(new Point(10, 6), TypeBloc.MUR);
        this.blocs[10][7] = new Bloc(new Point(10, 7), TypeBloc.MUR);
        ...
        this.blocs[10][11] = new Bloc(new Point(10, 11), TypeBloc.MUR);
